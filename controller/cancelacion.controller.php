...
require_once 'model/equipos_reservados.php';
require_once 'model/cancelacion.php';
...
class CancelacionController{
    ...
    public function __CONSTRUCT(){
        $this->model = new Equipos_reservados();
    }
    
    public function Index(){
        require_once 'view/header.php';
        require_once 'view/cancelacion/cancelacion.php';
    ...
    public function Crud(){
        ...
        require_once 'view/header.php';
        require_once 'view/cancelacion/cancelacion-editar.php';
        require_once 'view/footer.php';
    }
    
    public function Guardar(){
        $equ = new Equipos_reservados();
    ...
    public function Cancelar(){
        $dev = new Cancelacion();
        $dev->Cancelar($_REQUEST['id_empleado_entrega'],$_REQUEST['id_equipo'],$_REQUEST['observacion']);
        header('Location: index.php?c=cancelacion');
    }
