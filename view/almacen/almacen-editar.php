...
<form id="frm-alumno" action="?c=Almacen&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" id="fecha_entrada" name="fecha_entrada" value="<?php echo $alm->fecha_entrada; ?>" class="form-control" placeholder="Ingrese Fecha de Entrada" data-validacion-tipo="requerido|min:10" />
    </div>
    
    <div class="form-group">
        <label>Fecha de Despacho</label>
        <input type="text" id="fecha_despacho" name="fecha_despacho" value="<?php echo $alm->fecha_despacho; ?>" class="form-control" placeholder="Ingrese Fecha de Despacho" data-validacion-tipo="requerido|min:10" />
    </div>
...
$(function(){
    $("#fecha_entrada","#fecha_despacho").datepicker({
        dateFormat: "yy-mm-dd",
        changeMonth: true,
        changeYear: true,
