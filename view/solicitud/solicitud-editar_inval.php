...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="fecha_factura" value="<?php echo $equ->fecha_factura; ?>" class="form-control" placeholder="Ingrese Fecha de Factura del Equipo" data-validacion-tipo="requerido|min:3" />
    </div>
   <div class="form-group">
