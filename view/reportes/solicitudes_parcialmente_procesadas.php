...
$sol = new Solicitud();
$soli = $sol->Listar_parcialmente_procesadas();


$output = "reporte3";

$tit = "<br><br><br><table border='0'><thead><tr><th style='width:800px;' align='center'>Listado de Solicitudes Pendientes</th></tr></thead></table>";
$pdf_ext = ".pdf";
$enc='<table width="100%">
    <tr>
...
<table width="100%">
      <tr>
         <td width="100%" align="center">Listado de Solicitudes Pendientes</td>
      </tr>
</table>';
