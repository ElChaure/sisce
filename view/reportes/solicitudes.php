...
$tit = "<br><br><br><table border='0'><thead><tr><th style='width:800px;' align='center'>Listado General de Solicitudes</th></tr></thead></table>";
$pdf_ext = ".pdf";
$enc='<table width="100%">
    <tr>
...
<table width="100%">
      <tr>
         <td width="100%" align="center">Listado General de Solicitudes</td>
      </tr>
</table>';
