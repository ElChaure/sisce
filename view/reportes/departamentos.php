...
$sol = new Departamento();
$soli = $sol->Listar();


$output = "reporte3";

$tit = "<br><br><br><table border='0'><thead><tr><th style='width:800px;' align='center'>Listado de Departamentos</th></tr></thead></table>";
$pdf_ext = ".pdf";
$enc='<table width="100%">
    <tr>
...
<table width="100%">
      <tr>
         <td width="100%" align="center">Listado de Departamentos</td>
      </tr>
</table>';
