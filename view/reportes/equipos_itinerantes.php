...
$equipos = $equip->Listar_itinerantes();

$output = "report$id_e$if_fun_os =mp_os =e3";

$tit = "<br><br><br><table border='0'><thead><tr><th style='width:800px;' align='center'>Reporte de Equipos o Bienes Itinerantes</th></tr></thead></table>";
$pdf_ext = ".pdf";
$enc='<table width="100%">
    <tr>
...
<table width="100%">
      <tr>
         <td width="100%" align="center">Reporte de Equipos o Bienes Itinerantes</td>
      </tr>
</table>';
...
foreach ($equipos as $key => $value) {
  $linea= '<tr>
           ...
           <td>'.$value->id_solicitud_detalle_reserva.'</td>
           </tr>';
  $pdf->WriteHTML($linea);
  $nro=$nro+1;
}
