...
<form id="frm-alumno" action="?c=Equipo&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="cod_equipo" value="<?php echo $equ->cod_equipo; ?>" class="form-control" placeholder="Ingrese Codigo del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>
    <div class="form-group">
        <label>Serial Equipo</label>
        <input type="text" name="serial" value="<?php echo $equ->serial; ?>" class="form-control" placeholder="Ingrese Serial del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="descripcion" value="<?php echo $equ->descripcion; ?>" class="form-control" placeholder="Ingrese Descripcion del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>     
    <div class="form-group">
        <label>Numero de Factura del Equipo</label>
        <input type="text" name="num_factura" value="<?php echo $equ->num_factura; ?>" class="form-control" placeholder="Ingrese Numero de Factura del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>     
    <div class="form-group">
        <label>Fecha de Factura del Equipo</label>
        <input type="text" id="fecha_factura" name="fecha_factura" value="<?php echo $equ->fecha_factura; ?>" class="form-control" placeholder="Ingrese Fecha de Factura del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>
  ...
  <div class="form-group">
        ...
        <select id="id_proveedor" name="id_proveedor" style="width:200px;" title="Ingrese Proveedor del Equipo o Articulo.">
           <option value="1"><-- Seleccione --></option>
           <?php $l=make_combo($prove,"id_proveedor","nombre_prov","",0);?>
       </select>
   ...
   <div class="form-group">
        ...
        <input type="text" name="valor" value="<?php echo $equ->valor; ?>" class="form-control" placeholder="Ingrese Valor del Equipo" data-validacion-tipo="requerido|min:3" disabled/>
    </div>      
