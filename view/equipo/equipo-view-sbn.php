...
<!--/ol-->
<h1 class="page-header">Asignacion de Bien Nacional a Equipos</h1>
...
<table class="table table-striped" id="tabla_solicitud">
    ...
    <tbody>
    <!--?php foreach($this->model->Listar_sin_bn() as $r): ?-->
    <?php foreach($this->model->Listar() as $r): ?>
        <tr>
            ...
            <td>
                <a  class="btn btn-info"  href="?c=Equipo&a=Sbn&id_equipo=<?php echo $r->id_equipo; ?>">Asigna Bien Nacional</a>
            </td>
